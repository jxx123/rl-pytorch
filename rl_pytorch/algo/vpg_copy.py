...
def vpg(
    ...
    def update():
        ...
        print(
            f"pi_loss: {loss_pi:.3f}, pi_kl: {pi_info['kl']:.3f}, clip_frac: {pi_info['cf']:.3f}, pi_entropy: {pi_info['ent']:.3f}, v_loss: {loss_v:.3f}"
        )
    ...
    for epoch in range(epochs):
        ...
        mean_ep_len = np.mean(np.array(ep_lens))
        print(f"Epoch {epoch}: return {mean_ret}, ep_len {mean_ep_len}")
